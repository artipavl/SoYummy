...
export const ModalContainer = styled.div`
  ...
  background-image: url(${props =>
    mobImages[Math.floor(Math.random() * mobImages.length)]});
  background-repeat: no-repeat;
  background-size: cover;

  @media ${props => props.theme.retinaBackgroundImage} {
    background-image: url(${props =>
      mob2xImages[Math.floor(Math.random() * mob2xImages.length)]});
  }
  ...
  @media ${props => props.theme.device.tablet} {
    ...
    height: 400px;
    background-image: url(${props =>
      tabletImages[Math.floor(Math.random() * tabletImages.length)]});
    border-radius: 30px;

    @media ${props => props.theme.retinaBackgroundImage} {
      background-image: url(${props =>
        tablet2xImages[Math.floor(Math.random() * tablet2xImages.length)]});
    }
  }
  ...
  @media ${props => props.theme.device.desktop} {
    ...
    @media ${props => props.theme.retinaBackgroundImage} {
      background-image: url(${props =>
        desktop2xImages[Math.floor(Math.random() * desktop2xImages.length)]});
    }
  }
`;
